        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    TraceRealAndOutItemDTO dto = AdminController.checkItem(hash);
                    ...
                    if (choice2 == 1) {
                        AdminController.resolveBadLikeOrAppeal(hash, true, true);
                        System.out.println("成功处罚该用户");
                    } else if (choice2 == 2) {
                        AdminController.resolveBadLikeOrAppeal(hash, false, true);
                ...
                case 2:
                    ...
                    TraceRealAndOutItemDTO traceRealAndOutItemDTO = AdminController.checkItem(hash1);
                    System.out.println("该产品的真实信息为：");
                    ...
                    if (choice1 == 1) {
                        AdminController.resolveBadLikeOrAppeal(hash1, true, false);
                        System.out.println("商家申诉成功");
                    } else if (choice1 == 2) {
                        AdminController.resolveBadLikeOrAppeal(hash1, false, false);
